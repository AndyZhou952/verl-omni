# Z-Image-Turbo LoRA FlowGRPO with PickScore reward on T2IS-style prompts.
set -x
...
t2is_train_path=${T2IS_TRAIN_PATH:-$WORKSPACE/data/t2is/z_image/train.parquet}
t2is_test_path=${T2IS_TEST_PATH:-$WORKSPACE/data/t2is/z_image/test.parquet}
...
pickscore_processor_path=${PICKSCORE_PROCESSOR_PATH:-laion/CLIP-ViT-H-14-laion2B-s32B-b79K}
...
python3 -m verl_omni.trainer.main_diffusion \
    ...
    data.train_files=$t2is_train_path \
    data.val_files=$t2is_test_path \
    ...
    "+reward.reward_functions.pickscore.path=$repo_root/$reward_function_path" \
    ...
    "+reward.reward_functions.pickscore.device=$REWARD_DEVICE" \
