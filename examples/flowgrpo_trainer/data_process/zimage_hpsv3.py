...
"""
Preprocess DanceGRPO prompts to parquet format (for Z-Image-Turbo HPSv3 training).
You can obtain the raw prompts from https://github.com/xingjianbai/DanceGRPO (video_prompts.txt).
"""
