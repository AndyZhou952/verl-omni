# Z-Image-Turbo LoRA RL with external GenEval HTTP reward, vllm_omni rollout
# use examples/flowgrpo_trainer/data_process/zimage_geneval.py to prepare data
set -x

# Set WORKSPACE to any writable directory; defaults to $HOME
WORKSPACE=${WORKSPACE:-$HOME}

geneval_train_path=$WORKSPACE/data/geneval/z_image/train.parquet
geneval_test_path=$WORKSPACE/data/geneval/z_image/test.parquet

model_name=Tongyi-MAI/Z-Image-Turbo
GENEVAL_REWARD_SERVER_URL=${GENEVAL_REWARD_SERVER_URL:-http://localhost:19083}
...
python3 -m verl_omni.trainer.main_diffusion \
    ...
    '+reward.reward_functions.geneval.request_format=geneval' \
    '+reward.reward_functions.geneval.fail_on_error=True' \
