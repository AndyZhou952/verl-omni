#!/usr/bin/env bash
# Qwen3-Omni Thinker GSPO + LoRA training on MMK12 with the omni fully-async V1 trainer.
# 4 GPUs: 2 for the FSDP trainer, 2 for one standalone TP=2 rollout replica.
# Generation runs continuously; the staleness gate keeps
# trainer.v1.omni_fully_async.staleness_threshold + 1 prompt batches in flight.
#
...
python3 -m verl_omni.trainer.main_omni \
    ...
    trainer.experiment_name=qwen3_omni_thinker_lora_mmk12_fully_async \
