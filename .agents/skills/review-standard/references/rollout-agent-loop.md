...
- Anything touching engine coupling, worker extensions, ports, or weight transfer: flag for the vllm-omni domain expert rather than guessing (Mike pings @knlnguyen1802; NPU questions go to the NPU owners).
