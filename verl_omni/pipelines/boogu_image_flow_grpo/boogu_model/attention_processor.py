...
# boogu/models/attention_processor.py, commit a366095.
# Modified: rewrote intra-package imports as relative imports within boogu_model.
# Modified: repo ruff auto-fixes (typing modernization, zip strict=False, warning stacklevel,
#           removed unused locals, wrapped long comment/docstring lines); no functional changes.
import math
import warnings
...
class BooguImageDoubleStreamSelfAttnProcessorFlash2Varlen(nn.Module):
    ...
    def _concat_instruction_image_features(
        ...
        for img_tensor, instruct_tensor in zip(img_hidden_states_list, instruct_hidden_states_list, strict=False):
    ...
    def _split_instruction_image_features(
        ...
        for hidden_states in hidden_states_list:
            ...
            max_img_len = max(
                ...
                for seq_len, encoder_seq_len in zip(seq_lengths, encoder_seq_lengths, strict=False)
            )
...
class BooguImageDoubleStreamSelfAttnProcessor(nn.Module):
    ...
    def __call__(
        ...
        # explicitly repeat key and value to match query length, otherwise using enable_gqa=True
        # results in MATH backend of sdpa in our test of pytorch2.6
...
class BooguImageAttnProcessorFlash2Varlen:
    ...
    def _upad_input(
        ...
        Args:
            ...
            attention_mask: Attention mask tensor of shape (batch_size, seq_len) or
                (batch_size, seq_len, seq_len) for causal
