...
# boogu/models/transformers/block_lumina2.py, commit a366095.
...
#           fused SwiGLU gated only on is_flash_attn_available().
# Modified: repo ruff auto-fixes (typing modernization, warning stacklevel, wrapped a long
#           comment line); no functional changes.
import warnings
...
if is_flash_attn_available():
    ...
    warnings.warn(
        "Cannot import flash_attn, install flash_attn to use fused SwiGLU for better performance", stacklevel=2
    )
