...
# boogu/utils/teacache_util.py, commit a366095.
# Modified: wrapped one over-long docstring line for repo ruff config; no functional changes.
"""
...
class TeaCacheParams:
    ...
    Args:
        ...
        previous_modulated_inp (Optional[torch.Tensor]):
            The modulated input from the previous timestep used to indicate the change of
            the transformer layer's output.
